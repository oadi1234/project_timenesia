...
public class PlayerConstants : ScriptableObject
{
    ...
    public float wallJumpPersistenceModifier = 1f; //increases time counted after jumping, so holding the key is a bit shorter. To count by how much it decreases do 1/(this variable)
