...
{ 
    ...
    FadeWave = 3,   //Text has a wave of transition color travelling through it.
    Pulse = 4,      //Text pulses in size. TODO might be unused, but might fit mechanical entities?
    GradientWave = 5//Text cycles through a list of colours in a wave, similar to FadeWave.
}
